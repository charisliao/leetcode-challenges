...
# elements which are not equal to val. The remaining elements of nums are no
...
if __name__ == "__main__":
    ...
    nums = [3,2,2,3]
    val = 3
    print(removeElement(nums, val))  # 2, nums = [2,2]

    # test case 2
    nums = [0,1,2,2,3,0,4,2]
    val = 2
    print(removeElement(nums, val))  # 5, nums = [0,1,4,0,3]
